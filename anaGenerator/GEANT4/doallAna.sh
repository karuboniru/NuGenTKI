export TESTBEAM=list/Filelist_GEANT4_Piplus_Ar_1GeVc_1b.txt
...
tag=TESTBEAM_Piplus-1GeVc-Ar_1bstat_HASthreshold${ntostop}_WrestXrest
#TESTBEAM_Piplus-1GeV-Ar_10000xstat_HASthreshold_Wrest_xrest
#TESTBEAM_Electron-1GeV-Ar_10000xstat_HASthreshold_Wrest_xrest
#
#
#
