...
task=wider_smeared_IsGoodFilter_Wrest_xrest_Q2_SPK_All_10files_10b

outdir=outplot/outdraw${task}

mkdir -p ${outdir}

for infile in outplot/outAna11_TESTBEAM_smeared_IsGoodFilter_HASthreshold__WrestXrestQ2SPKAll_Filelist_GEANT4_Piplus_Ar_1GeVc_1bTESTBEAM_Filelist_GEANT4_Piplus_Ar_1GeVc_1b.root

              #outplot/OutplotList_outAna11_TESTBEAM_IsGoodFilter_HASthreshold__WrestXrestQ2SPKAll_Filelist_GEANT4_Piplus_Ar_1GeVc_2TESTBEAM.log
