...
task=_Wrest_xrest_Q2_SPK_All_10files_10b

outdir=outplot/outdraw${task}

mkdir -p ${outdir}

for infile in outplot/OutplotList_outAna11_TESTBEAM_HASthreshold_WrestXrestQ2SPKAll_Filelist_GEANT4_Piplus_Ar_1GeVc_2TESTBEAM.log
