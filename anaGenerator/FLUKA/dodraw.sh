...
task=_NOFSI10Files_IsGoodFilter_WrestXrestQ2SPK
outdir=outplot/outdraw${task}

mkdir -p ${outdir}

for infile in outplot/outAna11_TESTBEAM_Piplus-1GeVc-Ar_NOFSI10Files_IsGoodFilter_HASthreshold_WrestXrestQ2SPKTESTBEAM_Filelist_FLUKA_Pion_v01GeVc_NOFSI_10file.root
