export TESTBEAM=list/Filelist_FLUKA_Pion_v01GeVc_18files.txt

#list/Filelist_FLUKA_Pion_v01GeVc_NOFSI_10file.txt
...
tag=TESTBEAM_smeared_Piplus-1GeVc-Ar_IsGoodFilter_HASthreshold_WrestXrestQ2SPK
#TESTBEAM_Piplus-1GeVc-Ar_NOFSI10Files_IsGoodFilter_HASthreshold_WrestXrestQ2SPK
