...
for anaid in  MINERvANuWroGFS0PIa9t1nuCarbon MINERvANuWroGFSPIZEROa7t4nuCarbon
...
do
    ...
    if [  $anaid == GFS0PIMINERvAGENIE_v3OOB_LE_CarbonOnly -o $anaid == MINERvANuWroGFS0PIa9t1nuCarbon -o $anaid == GFS0PIMINERvAGENIE_v2DC_LE_CarbonOnly -o $anaid == GFS0PIMINERvAGENIE_V2RG_LE_CarbonOnly -o $anaid == GFS0PIMINERvAGiBUULE_CarbonOnly -o $anaid == GFS0PIMINERvAGENIEv2TJ_LE_CarbonOnly -o $anaid == MINERvAGENIEGFS0PIa9t1nuCarbon  -o $anaid == MINERvALEGiBUUGFS0PIa9t1nuCarbon -o $anaid == GFS0PIMINERvAGiBUULE_newE -o $anaid == GFS0PIMINERvAGiBUULE_newEtestnewvar ]
    then
        varray=${commonVar}" protonmomentum protontheta dpt dphit dalphat IApN"
    elif [ $anaid == GFSPIZEROMINERvAGENIE_v3OOB_LE_CarbonOnly -o $anaid == MINERvANuWroGFSPIZEROa7t4nuCarbon  -o $anaid == GFSPIZEROMINERvAGENIE_v2DC_LE_CarbonOnly -o $anaid == GFSPIZEROMINERvAGENIE_V2RG_LE_CarbonOnly -o $anaid == GFSPIZEROMINERvAGiBUULE_CarbonOnly -o $anaid == GFSPIZEROMINERvAGENIEv2TJ_LE_CarbonOnly -o $anaid == MINERvAGENIEGFSPIZEROa7t4nuCarbon -o $anaid == MINERvALEGiBUUGFSPIZEROa7t4nuCarbon  -o $anaid == GFSPIZEROMINERvAGiBUULE_newE -o $anaid == GFSPIZEROMINERvAGiBUULE_newEtestnewvar ]
    then
